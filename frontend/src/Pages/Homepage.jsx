  ...
  return (
    <div className="">
      ...
      <div className="space-y-10 py-20">
        {/*We are sending different data to sliding window below main carousel 
        data contain from hard coded value and section is header name that will display on the slides */}
